...
class prank extends StatefulWidget {
  @override
  _prankState createState() => _prankState();
}

class _prankState extends State<prank> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: Text('Prank Genrator',style: TextStyle(color: Colors.white),),
        elevation: 0,
