...
class biogenrator extends StatefulWidget {
  @override
  _biogenratorState createState() => _biogenratorState();
}

class _biogenratorState extends State<biogenrator> {
  ...
  void _generateResponse(String question) async {
    ...
    Map<String, dynamic> data = {
      "prompt":"write a cheesy bio for my  tinder account with following keywords" + prompt,
      "model": model,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: Text('Dating bio Genrator',style: TextStyle(color: Colors.white),),
        elevation: 0,
