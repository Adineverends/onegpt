...
class flirtyMessage extends StatefulWidget {
  @override
  _flirtyMessageState createState() => _flirtyMessageState();
}

class _flirtyMessageState extends State<flirtyMessage> {
  ...
  void _generateResponse(String question) async {
    ...
    Map<String, dynamic> data = {
      "prompt":"write a flirty message response  for this message " +prompt,
      "model": model,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: Text('flirty messages Genrator',style: TextStyle(color: Colors.white),),
        elevation: 0,
