...
class relationshipadvice extends StatefulWidget {
  @override
  _relationshipadviceState createState() => _relationshipadviceState();
}

class _relationshipadviceState extends State<relationshipadvice> {
  ...
  void _generateResponse(String question) async {
    ...
    Map<String, dynamic> data = {
      "prompt":"Give me relationship advice for this situation " +prompt,
      "model": model,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: Text('Relationship Advice',style: TextStyle(color: Colors.white),),
        elevation: 0,
