...
class captiongenartor extends StatefulWidget {
  @override
  _captiongenartorState createState() => _captiongenartorState();
}

class _captiongenartorState extends State<captiongenartor> {
  ...
  void _generateResponse(String question) async {
    ...
    Map<String, dynamic> data = {
      "prompt":"Genrate a caption for a instagram post for these keywords" + prompt,
      "model": model,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: Text('Caption Genrator',style: TextStyle(color: Colors.white),),
        elevation: 0,
