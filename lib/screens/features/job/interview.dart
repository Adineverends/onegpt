...
class _interviewState extends State<interview> {
  ...
  void _generateResponse(String question) async {
    ...
    Map<String, dynamic> data = {
      "prompt":"write a  sample resume for  "+prompt+" in section wise manner , sections include name,email,phone,summary,experience,skills,projects,experience,education,certifications,hobbies,refrences,achivements etc ",
      "model": model,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text('Interview Questions',style: TextStyle(color: Colors.black),),
        elevation: 0,
